...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    { foto_id: fotos[1].id, etiqueta_id: etiquetas[0].id, createdAt: new Date(), updatedAt: new Date() },
    { foto_id: fotos[2].id, etiqueta_id: etiquetas[0].id, createdAt: new Date(), updatedAt: new Date() },
    { foto_id: fotos[3].id, etiqueta_id: etiquetas[0].id, createdAt: new Date(), updatedAt: new Date() },
    { foto_id: fotos[4].id, etiqueta_id: etiquetas[0].id, createdAt: new Date(), updatedAt: new Date() },
    { foto_id: fotos[5].id, etiqueta_id: etiquetas[1].id, createdAt: new Date(), updatedAt: new Date() },
    ...
    { foto_id: fotos[9].id, etiqueta_id: etiquetas[1].id, createdAt: new Date(), updatedAt: new Date() }
    ], {});
